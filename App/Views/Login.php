...
<body class="bg-light d-flex flex-column gap-5 align-items-center d-flex vh-100">
  ...
  <div class="d-flex justify-content-center flex-column">
    <div class="bg-white p-4 rounded shadow-md justify-content-center" style="width: 30rem;">
